...
%%Changed from unlimited bry_time ryan 21/9/12
%Dname.time = 'bry_time';     Dsize.time = 12;%nc_constant('nc_unlimited');
Dname.time = 'bry_time';     Dsize.time = nc_constant('nc_unlimited');

% $$$ Dname.v2d_time = 'v2d_time';     Dsize.v2d_time = 31;
% $$$ Dname.temp_time = 'temp_time';     Dsize.temp_time = 31;
% $$$ Dname.v3d_time = 'v3d_time';     Dsize.v3d_time = 31;
% $$$ Dname.salt_time = 'salt_time';     Dsize.salt_time = 31;
...
% $$$   disp('  ');
% $$$   disp(mexnc('strerror',status));
% $$$   error(['C_BOUNDARY: DEF_DIM - unable to define dimension: ',Dname.v2d_time]);
% $$$ end
% $$$ 
...
% $$$   disp('  ');
% $$$   disp(mexnc('strerror',status));
% $$$   error(['C_BOUNDARY: DEF_DIM - unable to define dimension: ',Dname.v3d_time]);
% $$$ end
% $$$ 
...
% $$$   disp('  ');
% $$$   disp(mexnc('strerror',status));
% $$$   error(['C_BOUNDARY: DEF_DIM - unable to define dimension: ',Dname.temp_time]);
% $$$ end
% $$$ 
...
% $$$   disp('  ');
% $$$   disp(mexnc('strerror',status));
% $$$   error(['C_BOUNDARY: DEF_DIM - unable to define dimension: ',Dname.salt_time]);
% $$$ end
