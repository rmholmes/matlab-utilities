...
% svn $Id: extract_coast.m 586 2012-01-03 20:19:25Z arango $
%===========================================================================%
...
switch job,
  case 'seagrid'
    Oname='global_coasts.mat';
  case 'ploting'
    Oname='uswest_inter.cst';
end,

 GSHHS_DIR='/home/ryan/GFD_Research/Data_Analysis/Utilities/mat_data/GSHHS/';
...
Llon=-360.0;              % Left   corner longitude     % US west Coast
Rlon=0.0;              % Right  corner longitude
