...
if (S.def_zeta),
 Dname.zeta_time = 'zeta_time';    Dsize.zeta_time = nc_constant('nc_unlimited');%S.zeta_time;
end

if (S.def_v2d),
 Dname.v2d_time  = 'v2d_time';     Dsize.v2d_time  = nc_constant('nc_unlimited');%S.v2d_time;
end

if (S.def_v3d),
 Dname.v3d_time  = 'v3d_time';     Dsize.v3d_time  = nc_constant('nc_unlimited');%S.v3d_time;
end

if (S.def_temp),
 Dname.temp_time = 'temp_time';    Dsize.temp_time = nc_constant('nc_unlimited');%S.temp_time;
end

if (S.def_salt),
 Dname.salt_time = 'salt_time';    Dsize.salt_time = nc_constant('nc_unlimited');%S.temp_time;
end
