function V = roms2romstime(ncname,D,R,Vname,Tindex,Rvector,varargin)
...
% svn $Id: roms2roms.m 630 2012-08-28 17:58:33Z arango $
%=========================================================================%
...
%%%BUG FIX for interpolating onto same H grid:%%%%%%%%%%
Istr = 1
Iend
Jstr = 1
Jend
