function [z]=get_depths(fname, igrid, idims, tindex, hvec);
%function [z]=get_depths(fname, gname, igrid, idims, tindex, hvec);
%
% From ROMS_matlab depths routine but altered by ryan to not use
% grid file name and to only extract portion of grid in horizontal
% directions.
%
%
...
%
%    hvec        = [xini yini xL yL] (added by ryan to only extract
%    portion of grid)
%
% On Output:
%
...
% svn $Id: depths.m 614 2012-05-02 21:52:32Z arango $
%=========================================================================%
...
if (hvec == 0)
    ...
    h = netcdf.getVar(ncid,netcdf.inqVarID(ncid,'h'),hvec(1:2)-1, ...
                           hvec(3:4),'double');
end
...
if (hvec == 0)
    ...
    if (tindex == 0),
        ...
        zeta = netcdf.getVar(ncid,netcdf.inqVarID(ncid,'zeta'),[hvec(1:2)-1 ...
                            tindex-1],[hvec(3:4) 1],'double');
        netcdf.close(ncid);
    end
end
